...
data class DataItemJadwal(
    ...
    @field:SerializedName("jenis_pesanan")
    val jenisPesanan: String? = null,

    @field:SerializedName("tour_brosur")
    val tourBrosur: String? = null,

    @field:SerializedName("tour_judul")
    val tourJudul: String? = null,

    @field:SerializedName("tour_min_orang")
    val tourMinOrang: String? = null,

    @field:SerializedName("tour_deskripsi")
    val tourDesc: String? = null,

    @field:SerializedName("tour_dp")
    val tourDP: Int? = null,
)
