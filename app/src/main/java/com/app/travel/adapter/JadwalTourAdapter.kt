...
import com.app.travel.databinding.ItemJadwalTourBinding
...
class JadwalTourAdapter(
    ...
    class DzikirHolder(private val binding: ItemJadwalTourBinding) :
